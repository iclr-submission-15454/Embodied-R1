# python3 -m accelerate.commands.launch --num_processes=8 --main_process_port=54321 eval/hf_inference_embspatial.py
...
def process_sample(sample, model, processor, device, reasoning_model, instruct_following, gen_args):
    ...
    answer = map_answer_options[sample["answer"]]
...
def main(task_name, model_name, model_path, reasoning_model, max_pixels, min_pixels, gen_args, instruct_following):
...
if __name__ == "__main__":
    ...
    model_path = "YOUR_USER_NAME/Embodied-R1-3B-v1"
    ...
    if reasoning_model:
        instruct_following = (
            ...
            r'With the overall format being: '
            r'<think> reasoning process here </think><answer>your answer here</answer>'
        )
    else:
        instruct_following = "Directly output the answer in the format of A, B, C, or D."
    ...
    main(task_name, model_name, model_path, reasoning_model, max_pixels, min_pixels, gen_args, instruct_following)